...
Revision ID: 0016_create_us_daily_index
Revises: 0015_create_hk_daily_index
...
revision: str = "0016_create_us_daily_index"
down_revision: str | Sequence[str] | None = "0015_create_hk_daily_index"
